...
def get_parser():
    ...
    parser.add_argument('--tsne_act', default=[0])
    parser.add_argument('--tsne_draw', default=False)
    return parser
...
class Processor():
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            n_act=np.array(self.arg.tsne_act)
